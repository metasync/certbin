...
RSpec.describe "PUT /issuer/certificates/:id/issue", type: [:request, :database] do
  ...
  context "given valid params" do
    ...
    it "issues a requested certificate" do
      ...
      expect(certificate["issuer"]).to eq("emailAddress=contact@freelan.org,CN=Freelan Sample Certificate Authority,OU=freelan,O=www.freelan.org,L=Strasbourg,ST=Alsace,C=FR")
